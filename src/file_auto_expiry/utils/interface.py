    ...
    for line in lines[2:]:
            ...
            if path_data["expired"]:
                ...
                for user in path_data["creators"]:
                    ...
                    target_dict = creator_info_deletion if time_vars["days_unused"] >= days_for_expiry + 7 else creator_info_expiry

                    if user[1] in target_dict:
                        target_dict[user[1]]["paths"][path_data["path"]] = time_vars
